...
function Clock() {
    ...
    const stringTime =get2digits(date.getHours()) + ":"+get2digits(date.getMinutes())+":"+ get2digits(date.getSeconds())
     || <br/> // часы24:минуты:секунды (01:02:03)/(23:02:03)/(24:00:00)/(00:00:01) // пишут студенты
    const stringDate = get2digits(date.getDate()) +"."+get2digits(date.getMonth()) +"."+date.getFullYear()
    ...
    const stringDay = new Intl.DateTimeFormat("en-US",
        {"weekday":"long"}).format(date) || <br/> // пишут студенты
